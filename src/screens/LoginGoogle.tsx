...
export default function LoginGoogle({ navigation }: Readonly<Props>) {
    ...
    try {
      const res = await axios.post(
        `https://kauth.google.com/oauth/token`,
        {
          ...
          client_id: Config.GOOGLE_REST_API_KEY,
  ...
  return (
    <View style={{ flex: 1, marginTop: 24, backgroundColor: '#fff' }}>
      <WebView
        ...
        source={{
          uri: `https://google.google.com/oauth/authorize?response_type=code&client_id=${Config.GOOGLE_REST_API_KEY}&redirect_uri=${Config.GOOGLE_REDIRECT_URI}`,
        }}
